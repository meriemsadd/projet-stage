...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid px-4">
            ...
            <?php if (! (Request::is('evenements/create'))): ?>
            <div class="collapse navbar-collapse" id="navMenu">
                <form class="search-form" action="<?php echo e(route('evenements.index')); ?>" method="GET">
                    <input class="form-control" type="search" placeholder="Rechercher un événement..." name="q" value="<?php echo e(request('q')); ?>" />
...
</html><?php /**PATH C:\Users\lenovo\projet-stage\resources\views/layouts/app.blade.php ENDPATH**/ ?>