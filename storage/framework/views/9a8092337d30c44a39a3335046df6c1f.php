    ...
    <div class="container-fluid px-4 d-flex align-items-center justify-content-between">
        ...
        <div class="d-flex flex-column align-items-start">
            <a class="navbar-brand" href="<?php echo e(route('acceuil')); ?>">
                <img src="<?php echo e(asset('images/R.png')); ?>" alt="Logo" style="height: 60px;" />
            </a>
        ...
        <!-- Bouton Se connecter -->
        <div class="ms-auto">
            <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-light px-4">Se connecter</a>
        </div>
    </div>
</nav>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 d-flex">
                    <div class="card event-card position-relative w-100">
                        <div class="position-relative">
                            <img src="<?php echo e($event->image_url ?? 'https://via.placeholder.com/400x180?text=Événement'); ?>" alt="Image de l'événement" class="event-image w-100" />
                            <span class="badge badge-position <?php echo e($event->badge); ?>">
                        ...
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title"><?php echo e($event->titre); ?></h5>
                            <p class="card-text">
                                📍 <?php echo e($event->lieu); ?> <br>
                                🕓 Du <?php echo e(\Carbon\Carbon::parse($event->date_de_début)->format('d/m/Y')); ?> à <?php echo e(\Carbon\Carbon::parse($event->heure)->format('H:i')); ?>

                                au <?php echo e(\Carbon\Carbon::parse($event->date_de_fin)->format('d/m/Y')); ?>

                            </p>
                            <a href="<?php echo e(route('evenements.show', $event->id)); ?>" class="btn btn-details mt-auto">Voir détails</a>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\Users\lenovo\projet-stage\resources\views/acceuil.blade.php ENDPATH**/ ?>